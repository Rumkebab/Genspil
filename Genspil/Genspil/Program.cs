...
{
    List<Spil> spilListe = new List<Spil>(); // Tom liste til at holde det nye spil (bruges ikke til andet end at oprette spillet)
    Console.Clear();
    ...
    spilListe.Add(nytSpil);
    SpilDataHandler.GemTilFil("Datafiler/spil.txt", spilListe);
    return nytSpil;
}
